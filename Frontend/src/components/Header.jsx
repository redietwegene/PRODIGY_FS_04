            ...
            {user ? (
                <div className="flex items-center">
                    ...
                    >
                        ...
                        <span className="absolute top-0 right-0 translate-x-1.5 -translate-y-1.5 text-xs font-semibold">
                    ...
                    <div
                        ...
                        className="flex items-center ml-3 border border-slate-400 rounded-full bg-gradient-to-tr to-slate-800 text-black via-white from-slate-800 hover:bg-gradient-to-br shadow-sm cursor-pointer"
                    >
                        <img
                            src={user.image}
                            alt="Profile"
                    ...
                    {isHeaderMenu && (
                        <div
                            ref={headerMenuBox}
                            className="absolute top-16 right-4 z-40 border border-slate-500 text-white bg-slate-700 w-40 h-24 py-2 flex flex-col items-center gap-1 rounded-md"
                        >
                            <div
                                onClick={() => {
                                    dispatch(setHeaderMenu(false));
                                ...
                                className="flex items-center w-full h-fit cursor-pointer justify-center hover:bg-slate-400 hover:text-black p-1"
                            >
                                <PiUserCircleLight fontSize={23} className="mr-2" />
                                <span>Profile</span>
                            </div>
                            <div
                                ...
                                className="flex items-center w-full h-fit cursor-pointer justify-center hover:bg-slate-400 hover:text-black p-1"
                            >
                                <IoLogOutOutline fontSize={21} className="mr-2" />
                                <span>Logout</span>
                            </div>
                        </div>
                    )}
